...
namespace TrainMaster.Infrastracture.Repository.RepositoryUoW
{
    public class RepositoryUoW : IRepositoryUoW
    {
        ...
        public IExamHistoryRepository ExamHistoryRepository
        {
            get
            {
                if (_examHistoryRepository is null)
                {
                    _examHistoryRepository = new ExamHistoryRepository(_context);
                }
                return _examHistoryRepository;
            }
        }

        public ICourseEnrollmentRepository CourseEnrollmentRepository
        {
            get
            {
                if (_courseEnrollmentRepository is null)
                {
