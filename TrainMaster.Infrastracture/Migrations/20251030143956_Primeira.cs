...
namespace TrainMaster.Infrastracture.Migrations
{
    ...
    public partial class Primeira : Migration
    {
        ...
        {
            // Create BadgeEntity table only if it doesn't exist (handles case where table already exists)
            migrationBuilder.Sql(@"
                DO $$
                BEGIN
                    IF NOT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'BadgeEntity') THEN
                        CREATE TABLE ""BadgeEntity"" (
                            ...
                            CONSTRAINT ""PK_BadgeEntity"" PRIMARY KEY (""Id"")
                        );
                    END IF;
                END $$;
            ");
            ...
            // Create UserEntity table only if it doesn't exist
            migrationBuilder.Sql(@"
                DO $$
                BEGIN
                    IF NOT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'UserEntity') THEN
            ...
            // Note: UserEntity CreateTable removed - handled by SQL above since table already exists
